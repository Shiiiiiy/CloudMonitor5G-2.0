...
public abstract class StringUtils {
	...
	public static Locale parseLocaleString(String localeString) {
		...
		if (null != parts) {
			...
			if (parts.length >= 2) {
				...
				// country
				// code sans the separator between the country code and the
				// variant.
	 ...
	 */
	public static boolean isValid(String validString, String regex) {
	 ...
	 */
	public static String composeStrings(String... strArray) {
		StringBuilder builder = new StringBuilder();
