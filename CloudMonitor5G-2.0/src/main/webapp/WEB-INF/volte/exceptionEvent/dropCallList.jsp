...
<html>
	<head>
	    <title>VoLTE质量专题----VoLTE异常事件----VoLTE语音掉话</title>
		...
		<script type="text/javascript">
			...
			function reloadThisPageTab(title,index){
				...
				var url;
				if('整体'==title){
					url = '${pageContext.request.contextPath}/voiceDropCall/goToWhole.action';
					if(0==wholeClickNum){
						$(target).tabs('update', {
							tab : currTab,
							options : {
					...
					url = '${pageContext.request.contextPath}/voiceDropCall/goToProblem.action';
