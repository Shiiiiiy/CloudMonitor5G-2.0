  ...
  <head>
	...
	<script type="text/javascript">
		...
		var testLogInfoColumns=[[
			...
			{field:'temperature',width:45,align:'center',title:'工作温度（℃）'},
			{field:'powerMode',width:60,align:'center',title:'电源模式'},
			{field:'spaceLeft',width:60,align:'center',title:'剩余磁盘空间（MB）'},
			{field:'filesLeft',width:60,align:'center',title:'未上传完成文件个数'},
			{field:'statusReportTime',width:90,align:'center',title:'状态时间'}
		]];
		$(function(){
		...
		function initTable(){
			$("#testLogInfoTable").datagrid({
				...
				url:'${pageContext.request.contextPath}/status/doPageListJson.action',
				title:'硬件状态监控列表',
				fitColumns:true,
				//填满区域
				fit:true,
