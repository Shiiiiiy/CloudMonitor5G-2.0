 ...
 */
@Entity
@Table(name = "IADS_5G_EMBB_LTE_REVERSE")
public class LteContrarilyCoverAnalysePojo  implements Serializable{
	...
	@Column(name = "LTE_FBESTNCELLRSRP")
