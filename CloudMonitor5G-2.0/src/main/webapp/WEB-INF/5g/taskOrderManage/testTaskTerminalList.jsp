...
<html>
  <head>
    <title>指定测试任务计划_设备树LIST页面</title>
	...
	<script type="text/javascript">
		...
		function clickTreeNode(node){
			...
			centerLayoutGoToPage('【'+node.text+'】指定测试任务列表','${pageContext.request.contextPath}/testTaskManage/testTaskListUI.action?cityId='+node.attributes.refId);
		}
	</script>
  </head>
  ...
  <body id="cc" class="easyui-layout" style="width:100%;height: 100%;margin: 0 auto;list-style:none;overflow:hidden;">
    	...
    	<!-- 中,终端列表 -->
    	<div  data-options="region:'center',title:'指定测试任务列表',content:createIframe('${pageContext.request.contextPath}/testTaskManage/testTaskListUI.action')" >
    	</div>
