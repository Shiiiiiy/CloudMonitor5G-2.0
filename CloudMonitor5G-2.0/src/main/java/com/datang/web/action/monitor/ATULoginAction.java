 ...
 * @name ATULoginAction
 * @author shenyanwei
 * @date 2016年7月11日下午2:58:34
 */
@SuppressWarnings("all")
@Controller
@Scope("prototype")
public class ATULoginAction extends PageAction implements
		ModelDriven<ATULoginRequestBean> {
	@Autowired
	...
	private ATULoginRequestBean atuLoginRequestBean = new ATULoginRequestBean();
	...
	public AbstractPageList doPageQuery(PageList pageList) {
		Set<String> boxIdsList = atuLoginRequestBean.getBoxIdsList();
		List<Long> cityIdsList = atuLoginRequestBean.getCityIdsList();
		Set<String> boxIdsSet = atuLoginRequestBean.getBoxIdsSet();
		...
		pageList.putParam("pageQueryBean", atuLoginRequestBean);
		return atuLoginService.pageList(pageList);
	}

	@Override
	public ATULoginRequestBean getModel() {
		return atuLoginRequestBean;
	}
