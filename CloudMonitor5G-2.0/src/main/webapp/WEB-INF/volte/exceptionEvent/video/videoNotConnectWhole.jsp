...
<html>
  <head>
    <title>VoLte专题----VoLte异常事件----视频未接通事件整体分析</title>
	...
	function initTable(){
		$.post("${pageContext.request.contextPath}/videoNotConnect/doWholeAnalysis.action",{},
			function(result){
				if (result.errorMsg) {
    		...
    		<div class="easyui-layout" style="width:100%;height: 100%;">
    			...
    			<div data-options="region:'north',border:false" style="height:92px;padding:0px;">
	    			<table id="wholeIndexTable0"  class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,title:'指标列表',tools:'#tt'" >
	    				<thead>
	    					<tr>
	    						<th data-options="field:'videoconnectsuccessratio',width:80,align:'center',formatter:numToFixed2Formatter">VOLTE视频<br>建立成功率</th>
	    						<th data-options="field:'videoattemptmocount',width:80,align:'center'">VOLTE视频<br>试呼次数</th>
	    						<th data-options="field:'videoconnectmocount',width:80,align:'center'">VOLTE视频<br>接通次数</th>
	    						<th data-options="field:'videoconnectdelay',width:80,align:'center'">视频呼叫建<br>立时延(ms)</th>
	    					</tr>
	    				</thead>
	    				<tbody>
	    					<tr>
		    	...
		    	<div data-options="region:'center',border:false" >
				    		<div class="easyui-panel" data-options="fit:true,title:'视频未接通统计'">
	    						<table id="wholeIndexTable1" class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,border:false"  >
				    				<thead>
				    					<tr>
				    						<th data-options="field:'eventNum',width:60,align:'center'">视频未接通数量</th>
