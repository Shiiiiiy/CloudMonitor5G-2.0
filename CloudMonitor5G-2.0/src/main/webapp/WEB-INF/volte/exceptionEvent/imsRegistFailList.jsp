...
<html>
	<head>
	    <title>VoLTE质量专题----VoLTE异常事件----IMS注册失败</title>
		...
		<script type="text/javascript">
			...
			function reloadThisPageTab(title,index){
				...
				var url;
				if('整体'==title){
					url = '${pageContext.request.contextPath}/imsRegistFail/goToWhole.action';
					if(0==wholeClickNum){
						$(target).tabs('update', {
							tab : currTab,
							options : {
					...
					url = '${pageContext.request.contextPath}/imsRegistFail/goToProblem.action';
