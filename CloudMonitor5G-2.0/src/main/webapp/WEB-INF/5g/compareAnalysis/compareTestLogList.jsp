...
<html style="width:100%;height: 100%;margin: 0 auto;list-style:none;overflow:hidden;">
  <head>
    <title>统计分析-5g对比分析-对比测试日志选择页面</title>
	...
	<script type="text/javascript">
		...
		function doAnalysis(){
			...
			// 以ajax方式，发送到服务器，完成操作
			$.post("${pageContext.request.contextPath}/compareAnalysis5g/saveCompareTestLogItem",{"compareTestLogItemIds":ids},
				function(result){
					if (result.errorMsg) {
						$.messager.alert("系统提示", result.errorMsg,'error');
					} else {
						goToPage('${pageContext.request.contextPath}/compareAnalysis5g/goToCompareAnalysis.action');
					}
				}
			,"json");
		}
			    	...
			    	<table width="100%">
			    		<tr>
				    		<td width="100%" align="center">
				    			...
				    			<a class="easyui-linkbutton" onclick="goToPage('${pageContext.request.contextPath}/compareAnalysis5g/goToCompareAnalysis.action');" style="width: 80px;" data-options="iconCls:'icon-undo'" >返回</a>
				    		</td>
			    		</tr>
			    	</table>
		    	</form>
