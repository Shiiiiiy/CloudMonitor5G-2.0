...
/**
 * VoLTE质量专题----语音质差路段分析,弱覆盖路段指标
 * 
 * @author yinzhipeng
 * @date:2015年11月4日 下午1:43:47
 * @version
 */
@Entity
@Table(name = "IADS_DISS_VOLTE_QBR_WEAK_COVER")
public class VolteQualityBadRoadWeakCover extends VolteQualityBadRoad {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2075608396555229802L;
	/**
	 * 问题路段RSRP均值
	 */
