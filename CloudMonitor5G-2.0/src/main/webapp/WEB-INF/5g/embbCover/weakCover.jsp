...
<html>
  <head>
	...
	function getTLI2QBRGpsPointActionUrl(){
		return "<%=basePath%>gisSql/queryEmbbCoverRoadsPoints.action?coverType=0";
	}
	...
	var roadRatePieOption = {
		    ...
		    legend: {
		        ...
		        data:[
					...
					'原因:邻区缺失;建议:建议添加邻区',
					'',
					'原因:距离脱离5G覆盖区域;建议:建议加站',
					'原因:小区反向覆盖导致;建议:反向覆盖,建议调整'
				],
		    ...
		    series : [
		        {
		            ...
		            data:[
		                {value:${embbCoverTotalIndex.reasonRateNumList[4].total}, name:'原因:其他原因;建议:天馈调整'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[2].total}, name:'原因:小区反向覆盖导致;建议:反向覆盖,建议调整'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[1].total}, name:'原因:邻区缺失;建议:建议添加邻区'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[0].total}, name:'原因:距离脱离5G覆盖区域;建议:建议加站'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[3].total}, name:'原因:小区波束异常;建议:天线权值优化'}
		                
		            ]
		        },
		        {
		            name:'原因:其他原因;建议:天馈调整',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[4].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[4].rate0t6},${embbCoverTotalIndex.reasonRateNumList[4].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[4].rate6t8},${embbCoverTotalIndex.reasonRateNumList[4].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[4].rate8t100}]
		        },
		        {
		            name:'原因:小区反向覆盖导致;建议:反向覆盖,建议调整',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[2].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[2].rate0t6},${embbCoverTotalIndex.reasonRateNumList[2].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[2].rate6t8},${embbCoverTotalIndex.reasonRateNumList[2].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[2].rate8t100}]
		        },
		        {
		        ...
		        {
		            name:'原因:距离脱离5G覆盖区域;建议:建议加站',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[0].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[0].rate0t6},${embbCoverTotalIndex.reasonRateNumList[0].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[0].rate6t8},${embbCoverTotalIndex.reasonRateNumList[0].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[0].rate8t100}]
		        },
		        {
		            name:'原因:小区波束异常;建议:天线权值优化',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[3].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[3].rate0t6},${embbCoverTotalIndex.reasonRateNumList[3].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[3].rate6t8},${embbCoverTotalIndex.reasonRateNumList[3].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[3].rate8t100}]
		        }
		    ]
		};
    	...
    	<div data-options="region:'east',border:false" style="width:55%;padding:0px 0px 0px 2px;">
    		<div  id="eastLayout" class="easyui-layout" style="width:100%;height: 100%;">
	    		...
	    		<div data-options="region:'center',border:false" style="padding:0px 0px 2px 0px;" >
	    			<table id="embbCoverTable" class="easyui-datagrid" data-options="title:'弱覆盖路段列表',scrollbarSize:0,fit:true,striped:true,fitColumns:true,rownumbers:true,singleSelect:true,remoteSort:false,multiSort:true,tools:'#tt2'"  >
	    				<thead>
	    					<tr>
	    						...
	    						<th data-options="field:'coverRate',width:45,align:'center',formatter:numToFixed2Formatter">弱覆盖<br/>占比<br/>（%）</th>
	    			...
	    			<div id="tt2" >
						<a href="#" style="width:60px;text-decoration:underline;" onclick="doAnalysis();" title="弱覆盖路段分析">确认分析</a>
	    		...
	    		<div data-options="region:'south',border:false" style="height:40%;">
	    			...
	    			<div id="southLayout0" class="easyui-layout" style="width:100%;height: 100%;">
						<div data-options="region:'center',border:false" style="padding:2px 0px 0px 0px;">
							<div class='easyui-panel' data-options="fit:true,title:'弱覆盖路段占比分析'">
								...
								<table id="embbCoverCellTable" class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,rownumbers:true,singleSelect:true,remoteSort:false,multiSort:true,border:false"  >
				    				<thead>
				    					<tr>
				    						...
				    						<th data-options="field:'distanceRate',width:60,align:'center',formatter:numToFixed2Formatter">弱覆盖<br/>路段持续<br/>距离占比(%)</th>
