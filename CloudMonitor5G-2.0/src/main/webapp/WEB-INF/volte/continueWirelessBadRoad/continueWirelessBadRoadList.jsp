...
function reloadThisPageTab(title,index){
	...
	var url;
	if('整体'==title){
		url = '${pageContext.request.contextPath}/volteCWBR/goToWhole.action';
		if(0==wholeClickNum){
			$(target).tabs('update', {
				tab : currTab,
				options : {
		...
		url = '${pageContext.request.contextPath}/volteCWBR/goToWeakCover.action';
		...
		url = '${pageContext.request.contextPath}/volteCWBR/goToDisturb.action';
		...
		url = '${pageContext.request.contextPath}/volteCWBR/goToNbCell.action';
		if(0==nbCellClickNum){
			$(target).tabs('update', {
				tab : currTab,
				options : {
		...
		url = '${pageContext.request.contextPath}/volteCWBR/goToOther.action';
		if(0==otherClickNum){
			$(target).tabs('update', {
				tab : currTab,
				options : {
