...
/**
 * volte质量专题---volte语音质差---邻区配置问题路段Dao
 * 
 * @author yinzhipeng
 * @date:2015年11月16日 上午10:15:18
 * @version
 */
@Repository
@SuppressWarnings("all")
public class NbCellDeficiencyDao extends
		GenericHibernateDao<VolteQualityBadRoadNbDeficiency, Long> {
	 ...
	 * @return
	 */
	public List<VolteQualityBadRoadNbDeficiency> queryNbDeficiencyRoadsByLogIds(
		...
		Criteria createCriteria = this.getHibernateSession().createCriteria(
				VolteQualityBadRoadNbDeficiency.class);
