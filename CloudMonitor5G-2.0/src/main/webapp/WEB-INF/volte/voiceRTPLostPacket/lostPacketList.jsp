...
<html>
	<head>
	    <title>VoLTE专题----VoLTE质量专题----语音RTP连续丢包</title>
		...
		<script type="text/javascript">
			...
			function reloadThisPageTab(title,index){
				...
				var url;
				if('整体'==title){
					url = '${pageContext.request.contextPath}/lostPacket/goToWhole.action';
					if(0==wholeClickNum){
						$(target).tabs('update', {
							tab : currTab,
							options : {
					...
					url = '${pageContext.request.contextPath}/lostPacket/goToProblem.action';
