 ...
 */
@Entity
@Table(name = "IADS_TESTLOG_GRID_50")
public class TestLogItemGrid50 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7153511499797542868L;
	/**
	 * 主键
	 */
	private Long id;
