...
/**
 * volte质量专题---volte语音质差---LTE添加建议Dao
 * 
 * @author yinzhipeng
...
public class NbCellDeficiencyLTEAddAdviceDao extends
		GenericHibernateDao<NbCellLteAddAdvice, Long> {
	 ...
	 * @return
	 */
	public List<NbCellLteAddAdvice> queryCellInfoByRoad(
	 ...
	 * @return
	 */
	public List<NbCellLteAddAdvice> queryCellInfoByRoad(Long roadId) {
