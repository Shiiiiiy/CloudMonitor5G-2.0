...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function initTable(){
			$.post("${pageContext.request.contextPath}/voiceDropCall/doWholeAnalysis.action",{},
				function(result){
					if (result.errorMsg) {
    		...
    		<div class="easyui-layout" style="width:100%;height: 100%;">
    			...
    			<div data-options="region:'north',border:false" style="height:92px;padding:0px;">
	    			<table id="wholeIndexTable0"  class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,title:'指标列表',tools:'#tt'" >
	    				<thead>
	    					<tr>
	    						<th data-options="field:'voltecallrate',width:80,align:'center',formatter:numToFixed2Formatter">VOLTE<br>呼叫占比</th>
	    						...
	    						<th data-options="field:'voltecalldropmocount',width:100,align:'center'">VOLTE主叫<br>掉话次数 </th>
	    						<th data-options="field:'voltecalldropmtcount',width:100,align:'center'">VOLTE被叫<br>掉话次数 </th>
		    	...
		    	<div data-options="region:'center',border:false" >
		    		<div class="easyui-layout" style="width:100%;height: 100%;">
				    	...
				    	<div data-options="region:'north',border:false" style="height:82px;padding:2px 0px 0px 0px;">
				    		<div class="easyui-panel" data-options="fit:true,title:'语音掉话统计'">
	    						<table id="wholeIndexTable1" class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,border:false"  >
				    				<thead>
				    					<tr>
				    						<th data-options="field:'eventNum',width:60,align:'center'">语音掉话数量</th>
