...
<html>
<head>
    <title>SA模式移动-系统内切换失败事件分析</title>
    ...
    <script type="text/javascript">
        ...
        var testLogInfoColumns=[[
	    		...
	    		{field:'lteCell',align:'center',colspan:7,title:'源小区信息'},
	    		{field:'TargetCell',align:'center',colspan:7,title:'LTE目标小区信息'}
			],[
	            /*异常基础信息*/
	            {field:'id',width:40,align:'center',title:'序号',hidden:true}, // 一个对象代表一列 <th>
	            {field:'city',width:150,align:'center',title:'城市',sortable:true},
	            {field:'scellChangeReqStartTime',width:100,align:'center',title:'切换请求发起时间',sortable:true},
	            {field:'scellChangeFailTimeLong',width:150,align:'center',title:'失败发生时间时间戳',sortable:true,hidden:true},
	            {field:'scellChangeFailTime',width:100,align:'center',title:'切换失败发生时间',sortable:true},
	            {field:'fileName',width:60,align:'center',title:'文件名称',sortable:true,
	                formatter:function(value,row,index){
	                    if(row.fileName){
	                        ...
	                        return '<a title="" href="${pageContext.request.contextPath}/samoveswitchexceptionview/downloadFile.action?fileId='+row.id+'&reqSeqNo='+row.testLogItem.recSeqNo+'" >'+filename+'</a>';
	                    }
	                    return value;
	                }
	            },
	            //{field:'roadName',width:60,align:'center',title:'道路名称',sortable:true,hidden:true},
	            {field:'longitude',width:60,align:'center',title:'经度',sortable:true},
	            {field:'dimension',width:60,align:'center',title:'纬度',sortable:true},
	
	            /*原因分析*/
	            {field:'scellChangeFailType',width:60,align:'center',title:'切换失败类型',sortable:true},
	            ...
	            {field:'nrTac',width:60,align:'center',title:'源小区TAC',sortable:true},
	            {field:'nrCellid',width:60,align:'center',title:'源小区CELLID',sortable:true},
	            {field:'nrFriendlyName',width:100,align:'center',title:'源小区小区友好名',sortable:true},
	            {field:'nrFrequencyPoint',width:100,align:'center',title:'源小区频点',sortable:true},
	            {field:'nrPci',width:60,align:'center',title:'源小区PCI',sortable:true},
	            {field:'nrPccRsrp',width:60,align:'center',title:'源小区ss-rsrp',sortable:true},
	            /*目标小区信息*/
	            {field:'nrTargetCellTac',width:60,align:'center',title:'目标小区TAC',sortable:true},
	            {field:'nrTargetCellCellid',width:60,align:'center',title:'目标小区CELLID',sortable:true},
	            {field:'nrTargetCellCellName',width:60,align:'center',title:'目标小区小区友好名',sortable:true},
	            {field:'nrTargetCellFrequency',width:60,align:'center',title:'目标小区频点',sortable:true},
	            {field:'nrTargetCellPci',width:60,align:'center',title:'目标小区PCI',sortable:true},
	            {field:'nrTargetCellSsRsrp',width:60,align:'center',title:'目标小区ss-rsrp',sortable:true,hidden:true}
	        ]];
        ...
        function initTable(){
            $("#testLogInfoTable").datagrid({
                ...
                url:'${pageContext.request.contextPath}/samoveswitchexceptionview/doPageListJson.action?',
                title:'SA模式移动性异常事件列表',
                fitColumns:false,
                //填满区域
                fit:true,
        ...
        function getGpsPointData(recSeqNo,timeLong,typeName,lon,lat){
        	$.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/samoveswitchexceptionview/getGpsPointData.action",
                data:{
                	'recSeqNo':recSeqNo,
                	'timeLong':timeLong
					},
        ...
        var query = function(){
            ...
            $("#testLogInfoTable").datagrid({
                // 表头
                columns:testLogInfoColumns,
                url:'${pageContext.request.contextPath}/samoveswitchexceptionview/doPageListJson.action?nrFriendlyName='+roadName,
                title:'SA模式移动性异常事件列表',
                fitColumns:false,
                //填满区域
                fit:true,
