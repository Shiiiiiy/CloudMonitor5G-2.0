...
<html>
  <head>
    <title>VoLte专题----VoLte切换失败----SRVCC切换失败整体分析</title>
	...
	<script type="text/javascript">
		...
		function initTable(){
			$.post("${pageContext.request.contextPath}/droppingSRVCC/doWholeAnalysis.action",{},
				function(result){
					if (result.errorMsg) {
    		...
    		<div class="easyui-layout" style="width:100%;height: 100%;">
    			...
    			<div data-options="region:'north',border:false" style="height:92px;padding:0px;">
	    			<table id="wholeIndexTable0"  class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,title:'指标列表',tools:'#tt'" >
	    				<thead>
	    					<tr>
	    						<th data-options="field:'lteesrvccctrlpaneldelay',width:80,align:'center',formatter:numToFixed2Formatter">eSRVCC<br>控制面</th>
	    						<th data-options="field:'lteesrvccuserpaneldelay',width:80,align:'center',formatter:numToFixed2Formatter">eSRVCC<br>用户面</th>
	    						...
	    						<th data-options="field:'esrvccsuccessrate',width:80,align:'center',formatter:numToFixed2Formatter">eSRVCC<br>成功率</th>
				    	...
				    	<div data-options="region:'north',border:false" style="height:82px;padding:2px 0px 0px 0px;">
				    		<div class="easyui-panel" data-options="fit:true,title:'切换失败统计'">
	    						<table id="wholeIndexTable1" class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,border:false"  >
				    				<thead>
				    					<tr>
				    						<th data-options="field:'eventNum',width:60,align:'center'">SRACC切换失败次数</th>
