 ...
 * 
 * @explain
 * @name StreamStatementeResponseBean
 * @author shenyanwei
 * @date 2017年10月23日下午5:30:35
 */
public class StreamStatementeResponseBean implements Serializable {
	/**
	 * 
	 */
	...
	/**
	 * @return the stallingratio
	 */
	public String getStallingratio() {
		return stallingratio;
	}

	/**
	 * @param the
	 *            stallingratio to set
	 */

	public void setStallingratio(String stallingratio) {
		this.stallingratio = stallingratio;
	}

	/**
	 * @return the initialbuffertime
	 */
	public String getInitialbuffertime() {
		return initialbuffertime;
	}

	/**
	 * @param the
	 *            initialbuffertime to set
	 */

	public void setInitialbuffertime(String initialbuffertime) {
	...
	public String toString() {
		return "StreamStatementeResponseBean [region=" + region + ", vender="
				...
				+ ", optimizationInfo=" + optimizationInfo + ", stallingratio="
				+ stallingratio + ", initialbuffertime=" + initialbuffertime
				+ ", videoresolution=" + videoresolution + ", vmos=" + vmos
				+ "]";
	}
