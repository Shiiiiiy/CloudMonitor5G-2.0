...
import com.datang.domain.VoLTEDissertation.qualityBadRoad.disturbProblem.DisturbProblemTianKuiAdjust;
...
public class DisturbTianKuiAdjustDao extends
		GenericHibernateDao<DisturbProblemTianKuiAdjust, Long> {
	/**
	 ...
	 * @return
	 */
	public List<DisturbProblemTianKuiAdjust> queryCellInfoByRoad(
		...
		Criteria createCriteria = this.getHibernateSession().createCriteria(
				DisturbProblemTianKuiAdjust.class);
