...
@Entity
@Table(name = "IADS_REPORT_CUSTOMLOG_ITEM")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
public class CustomUploadLogItemPojo implements Serializable, Comparable<CustomUploadLogItemPojo> {
	/**
	 * 
	 */
	...
	@Override
	public int compareTo(CustomUploadLogItemPojo o) {
