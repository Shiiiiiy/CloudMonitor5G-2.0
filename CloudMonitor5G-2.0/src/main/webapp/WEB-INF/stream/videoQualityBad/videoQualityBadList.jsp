...
function reloadThisPageTab(title,index){
	...
	var url;
	if('整体'==title){
		url = '${pageContext.request.contextPath}/streamQuality/goToWhole.action';
		if(0==wholeClickNum){
			$(target).tabs('update', {
				tab : currTab,
				options : {
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToPingPong.action';
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToNeighbourPlot.action';
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToWeakCover.action';
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToDisturb.action';
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToOverCover.action';
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToDownDispatchSmall.action';
		...
		url = '${pageContext.request.contextPath}/streamQuality/goToOther.action';
		if(0==otherClickNum){
			$(target).tabs('update', {
				tab : currTab,
				options : {
