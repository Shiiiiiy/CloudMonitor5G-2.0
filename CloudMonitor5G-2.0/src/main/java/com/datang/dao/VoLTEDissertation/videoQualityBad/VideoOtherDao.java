...
/**
 * volte质量专题---volte视频质差---其他问题Dao
 * 
 * @explain
 * @name VideoOtherDao
 * @author shenyanwei
 * @date 2017年5月12日下午1:18:29
 */
@Repository
@SuppressWarnings("all")
public class VideoOtherDao extends
		GenericHibernateDao<VideoQualityBadOther, Long> {
	/**
	 * 根据测试日志的id集合获取其他问题
	 * 
	 ...
	 * @return
	 */
	public List<VideoQualityBadOther> queryVideoOthersByLogIds(
	 ...
	 * @return
	 */
	public Integer queryVideoOtherNumByLogIds(List<Long> testLogItemIds) {
	 ...
	 * @return
	 */
	public List<Long> queryVideoOtherIdsByLogIds(List<Long> testLogItemIds) {
