...
/**
 * volte质量专题---volte语音质差---核心网问题路段Dao
 * 
 * @author yinzhipeng
 * @date:2015年12月29日 上午10:53:41
 * @version
 */
@Repository
@SuppressWarnings("all")
public class CoreNetworkDao extends
		GenericHibernateDao<VolteQualityBadRoadCoreNetwork, Long> {
	/**
	 * 根据测试日志的id集合获取核心网问题路段
	 * 
	 * @param testLogItemIds
	 * @return
	 */
	public List<VolteQualityBadRoadCoreNetwork> queryCoreNetworkRoadsByLogIds(
		...
		Criteria createCriteria = this.getHibernateSession().createCriteria(
				VolteQualityBadRoadCoreNetwork.class);
