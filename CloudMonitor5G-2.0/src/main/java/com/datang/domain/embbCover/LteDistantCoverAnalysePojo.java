 ...
 */
@Entity
@Table(name = "IADS_5G_EMBB_LTE_SPFAR")
public class LteDistantCoverAnalysePojo  implements Serializable{
	...
	@Column(name = "LTE_CBESTNCELLRSRP")
