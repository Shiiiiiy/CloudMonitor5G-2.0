  ...
  <head>
	...
	var roadRatePieOption = {
		    ...
		    legend: {
		        ...
		        data:[
					'原因:邻区缺失;建议:建议添加邻区',
				    '原因:小区无信号;建议:核查影响无线性能的告警',
				    '原因:超高站;建议:降低天线高度',
				    '',
				    '原因:天线倾角不合适;建议:增大天线下倾角',
				    '原因:下行功率分配不合理;建议:减小小区功率',
				    '原因:其他;建议:现场复测分析'
				],
		    ...
		    series : [
		        {
		            ...
		            data:[
		                {value:${embbCoverTotalIndex.reasonRateNumList[1].total}, name:'原因:邻区缺失;建议:建议添加邻区'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[5].total}, name:'原因:小区无信号;建议:核查影响无线性能的告警'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[6].total}, name:'原因:超高站;建议:降低天线高度'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[7].total}, name:'原因:天线倾角不合适;建议:增大天线下倾角'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[8].total}, name:'原因:下行功率分配不合理;建议:减小小区功率'},
		                {value:${embbCoverTotalIndex.reasonRateNumList[9].total}, name:'原因:其他;建议:现场复测分析'}
		            ]
		        },
		        {
		            name:'原因:邻区缺失;建议:建议添加邻区',
		            type:'bar',
		            stack:'数量',
		        ...
		        {
		            name:'原因:小区无信号;建议:核查影响无线性能的告警',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[5].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[5].rate0t6},${embbCoverTotalIndex.reasonRateNumList[5].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[5].rate6t8},${embbCoverTotalIndex.reasonRateNumList[5].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[5].rate8t100}]
		        },
		        {
		            name:'原因:超高站;建议:降低天线高度',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[6].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[6].rate0t6},${embbCoverTotalIndex.reasonRateNumList[6].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[6].rate6t8},${embbCoverTotalIndex.reasonRateNumList[6].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[6].rate8t100}]
		        },
		        {
		            name:'原因:天线倾角不合适;建议:增大天线下倾角',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[7].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[7].rate0t6},${embbCoverTotalIndex.reasonRateNumList[7].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[7].rate6t8},${embbCoverTotalIndex.reasonRateNumList[7].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[7].rate8t100}]
		        },
		        {
		            name:'原因:下行功率分配不合理;建议:减小小区功率',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
		            data:[${embbCoverTotalIndex.reasonRateNumList[8].rate0t6==0?"'-'":embbCoverTotalIndex.reasonRateNumList[8].rate0t6},${embbCoverTotalIndex.reasonRateNumList[8].rate6t8==0?"'-'":embbCoverTotalIndex.reasonRateNumList[8].rate6t8},${embbCoverTotalIndex.reasonRateNumList[8].rate8t100==0?"'-'":embbCoverTotalIndex.reasonRateNumList[8].rate8t100}]
		        },
		        {
		            name:'原因:其他;建议:现场复测分析',
		            type:'bar',
		            stack:'数量',
		            itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},
    	...
    	<div data-options="region:'east',border:false" style="width:55%;padding:0px 0px 0px 2px;">
    		<div  id="eastLayout" class="easyui-layout" style="width:100%;height: 100%;">
	    		...
	    		<div data-options="region:'center',border:false" style="padding:0px 0px 2px 0px;" >
	    			<table id="embbCoverTable" class="easyui-datagrid" data-options="title:'过覆盖路段列表',scrollbarSize:0,fit:true,striped:true,fitColumns:true,rownumbers:true,singleSelect:true,remoteSort:false,multiSort:true,tools:'#tt2'"  >
	    				<thead>
	    					<tr>
	    						...
	    						<th data-options="field:'coverRate',width:45,align:'center',formatter:numToFixed2Formatter">过覆盖<br/>占比<br/>（%）</th>
	    			...
	    			<div id="tt2" >
						<a href="#" style="width:60px;text-decoration:underline;" onclick="doAnalysis();" title="过覆盖路段分析">确认分析</a>
	    		...
	    		<div data-options="region:'south',border:false" style="height:40%;">
	    			...
	    			<div id="southLayout0" class="easyui-layout" style="width:100%;height: 100%;">
						<div data-options="region:'center',border:false" style="padding:2px 0px 0px 0px;">
							<div class='easyui-panel' data-options="fit:true,title:'过覆盖路段占比分析'">
								...
								<table id="embbCoverCellTable" class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,rownumbers:true,singleSelect:true,remoteSort:false,multiSort:true,border:false"  >
				    				<thead>
				    					<tr>
				    						...
				    						<th data-options="field:'distanceRate',width:60,align:'center',formatter:numToFixed2Formatter">过覆盖<br/>路段持续<br/>距离占比(%)</th>
