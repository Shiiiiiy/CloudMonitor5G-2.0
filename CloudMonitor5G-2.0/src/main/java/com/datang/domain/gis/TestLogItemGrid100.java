 ...
 */
@Entity
@Table(name = "IADS_TESTLOG_GRID_100")
public class TestLogItemGrid100 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7389813867653990715L;
	/**
	 * 主键
	 */
	private Long id;
