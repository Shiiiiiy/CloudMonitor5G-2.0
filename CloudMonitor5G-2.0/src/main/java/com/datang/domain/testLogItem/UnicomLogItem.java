...
public class UnicomLogItem implements Serializable, Comparable<UnicomLogItem> {
	/**
	 * 
	 */
	...
	@Override
	public int compareTo(UnicomLogItem o) {
	...
	@Column(name = "TRAFFIC_CHECK")
	public String getTrafficCheck() {
		return trafficCheck;
	}
	...
	@Transient
	public String getKpi4() {
		return kpi4;
	}

	public void setKpi4(String kpi4) {
		this.kpi4 = kpi4;
	}
	@Transient
	public String getKpi5() {
		return kpi5;
	}

	public void setKpi5(String kpi5) {
		this.kpi5 = kpi5;
	}
	@Transient
	public String getKpi6() {
		return kpi6;
	}

	public void setKpi6(String kpi6) {
		this.kpi6 = kpi6;
	}
	@Transient
	public String getKpi7() {
		return kpi7;
	}

	public void setKpi7(String kpi7) {
		this.kpi7 = kpi7;
	}
	@Transient
	public String getKpi8() {
		return kpi8;
	}

	public void setKpi8(String kpi8) {
		this.kpi8 = kpi8;
	}
	@Column(name = "CITY")
