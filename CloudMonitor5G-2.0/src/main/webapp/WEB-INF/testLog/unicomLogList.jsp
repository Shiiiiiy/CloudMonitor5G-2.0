...
<!-- 			    	<div class="inputDivShow">预存区域
			    	...
			    	<table width="100%">
			    		<tr>
				    		...
				    		<td width="5%" align="center"><a class="easyui-linkbutton" onclick="deleteLog();" style="width: 80px;" data-options="iconCls:'icon-reload'" >删除</a></td>
				    		<td width="5%" align="center"><a class="easyui-linkbutton" onclick="cheakDetail();" style="width: 80px;">校验详单</a></td>
				    		<td width="5%" align="center"><a class="easyui-linkbutton" onclick="seeInfo();" style="width: 80px;">数据概览</a></td>
				    		<td width="5%" align="center"><a class="easyui-linkbutton" onclick="showMap();" id="showMapId" style="width: 80px;" data-options="iconCls:'icon-networkStructure',disabled:true">轨迹详情</a></td>	
			    			<td width="5%" align="center"><a class="easyui-linkbutton" onclick="seeQuestion();" style="width: 80px;">问题索引</a></td>
			    			<td width="45%" align="left">
			    				<a class="easyui-menubutton" data-options="menu:'#_type'" style="width: 100px;">导出中间表</a>
			    				<div id="_type">
