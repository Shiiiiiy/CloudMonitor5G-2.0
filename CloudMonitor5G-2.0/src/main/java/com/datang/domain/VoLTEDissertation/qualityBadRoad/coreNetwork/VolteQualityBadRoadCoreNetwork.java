 ...
 * 
 */
package com.datang.domain.VoLTEDissertation.qualityBadRoad.coreNetwork;
...
/**
 * VoLTE质量专题----语音质差路段分析,核心网问题路段指标
 * 
 * @author yinzhipeng
 * @date:2015年11月4日 下午3:29:31
 * @version
 */
@Entity
@Table(name = "IADS_DISS_VOLTE_QBR_CORE_NET")
public class VolteQualityBadRoadCoreNetwork extends VolteQualityBadRoad {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8199447438165189683L;
	/**
	 * 上行RB数
	 */
