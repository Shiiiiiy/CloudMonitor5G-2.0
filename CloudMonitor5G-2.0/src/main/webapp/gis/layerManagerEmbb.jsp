			...
			<div data-options="closeable:'false',title:'连线',cache:false" style="padding:4px;">
				<div style="heigth: 45%;">
					...
					<div style="heigth: 40%;margin-top: 10px;">
						<input type="checkbox" style="display:none;"  id="cellCoverThreshold" name="cellCoverThreshold" value="1" 
...
/* 		if(targetChoose == 1){
	...
	function showCellLayer(){
		...
		mapIframe.window.LayerManageAddCellbyArray(cellShowFlag,colors,cellRange,layerManageData.cellData.showTarget.showTargetOption,showTargetFlag);
	}
