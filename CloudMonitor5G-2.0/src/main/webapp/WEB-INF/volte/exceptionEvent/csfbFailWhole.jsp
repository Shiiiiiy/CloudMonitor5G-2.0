...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function initTable(){
			$.post("${pageContext.request.contextPath}/csfbFail/doWholeAnalysis.action",{},
				function(result){
					if (result.errorMsg) {
    		...
    		<div class="easyui-layout" style="width:100%;height: 100%;">
    			...
    			<div data-options="region:'north',border:false" style="height:92px;padding:0px;">
	    			<table id="wholeIndexTable0"  class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,title:'指标列表',tools:'#tt'" >
	    				<thead>
	    					<tr>
	    						<th data-options="field:'csfb2gsmsuccessrate',width:80,align:'center',formatter:numToFixed2Formatter">CSFB回落GSM<br>成功比例(%)</th>
	    						<th data-options="field:'csfb2gsmdelay',width:80,align:'center',formatter:numToFixed2Formatter">CSFB回落GSM<br>时延(s)</th>
	    						<th data-options="field:'csfb2tdssuccessrate',width:80,align:'center',formatter:numToFixed2Formatter">CSFB回落TD<br>成功比例(%)</th>
	    						<th data-options="field:'csfb2tdsdelay',width:80,align:'center',formatter:numToFixed2Formatter">CSFB回落TD<br>平均时延(s)</th>
	    						<th data-options="field:'csfbcallrate',width:100,align:'center',formatter:numToFixed2Formatter">CSFB呼叫<br>占比(%)</th>
		    	...
		    	<div data-options="region:'center',border:false" >
		    		<div class="easyui-layout" style="width:100%;height: 100%;">
				    	...
				    	<div data-options="region:'north',border:false" style="height:82px;padding:2px 0px 0px 0px;">
				    		<div class="easyui-panel" data-options="fit:true,title:'CSFB失败统计'">
	    						<table id="wholeIndexTable1" class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,border:false"  >
				    				<thead>
				    					<tr>
				    						<th data-options="field:'eventNum',width:60,align:'center'">CSFB失败数量</th>
