...
<html>
  <head>
	...
	function doAnalysis(){
		...
		// 以ajax方式，发送到服务器，完成操作
		$.post("${pageContext.request.contextPath}/voiceQBR/doWeakCoverRoadAnalysis.action",{roadId:weakCoverRow.id},
			function(result){
				if (result.errorMsg) {
					...
					//指标列表
					if(weakCoverRoadName){
						$("#weakCoverIndexTable").datagrid('getPanel').panel('setTitle',weakCoverRoadName+"路段"+$("#weakCoverIndexTable").datagrid('options').title);
					}
					$("#weakCoverIndexTable").datagrid('loadData',result.weakCoverRoadIndex);
  ...
  <body class="easyui-layout" id="mainLayout" style="width: 100%;height: 100%;margin: 0 auto;padding: 0 auto;list-style:none;overflow:hidden;">
    	...
    	<div  data-options="region:'center',border:false" style="padding:0px 2px 0px 0px;">
    		<div class="easyui-panel" style="width: 100%;height: 100%;" data-options="fit:true">
    			<iframe name="mapIframe" src="${pageContext.request.contextPath}/gis/default.html?toolbarType=1" scrolling="auto" frameborder="0"  style="width:100%;height:100%;border:0;margin: 0;" ></iframe>
    		</div>
    	</div>
    	<!-- 东,指标列表和汇总统计信息 -->
  					...
  					<table id="weakCoverRoadTable" class="easyui-datagrid" data-options="title:'弱覆盖原因质差路段列表',scrollbarSize:0,fit:true,striped:true,fitColumns:true,rownumbers:true,singleSelect:true,tools:'#tt3',onLoadSuccess:mainTableLoadSuccess,remoteSort:false,multiSort:true"  >
	    				<thead>
	    					...
	    					<tr>
								...
								">优化建议</th>
	    						<th data-options="field:'mosType',width:70,align:'center'">MOS<br>业务类型</th>
		    	...
		    	<div data-options="region:'center',border:false" >
					<div class="easyui-layout" style="width:100%;height: 100%;">
						<div data-options="region:'north',border:false" style="height:106px;padding:2px 0px 0px 0px;">
							<table id="weakCoverIndexTable"   class="easyui-datagrid" data-options="scrollbarSize:0,fit:true,striped:true,fitColumns:true,title:'指标列表'" >
			    				<thead>
			    					<tr>
