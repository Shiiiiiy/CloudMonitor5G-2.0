...
<head>
    ...
    <script type="text/javascript">
        ...
        var testLogInfoColumns=[[
	    		...
	    		{field:'lteCell',align:'center',colspan:10,title:'服务小区信息'}
    		],[
            	/*异常基础信息*/
            	{field:'id',width:40,align:'center',title:'序号',hidden:true}, // 一个对象代表一列 <th>
            	{field:'city',width:150,align:'center',title:'城市',sortable:true},
	            {field:'scellChangeReqStartTime',width:100,align:'center',title:'接入请求发起时间',sortable:true},
	            {field:'scellChangeFailTime',width:100,align:'center',title:'接入失败发生时间',sortable:true},
	            ...
	            {field:'fileName',width:100,align:'center',title:'文件名称',sortable:true,
	                formatter:function(value,row,index){
	                    if(row.fileName){
	                        ...
	                        return '<a title="" href="${pageContext.request.contextPath}/saaccessexceptionview/downloadFile.action?fileId='+row.id+'&reqSeqNo='+row.testLogItem.recSeqNo+'" >'+filename+'</a>';
	                    }
	                    return value;
	                }
	            },
	            ...
	            /*原因分析*/
	            /*todo*/
	            {field:'scellChangeFailType',width:100,align:'center',title:'接入失败类型',sortable:true},
	            {field:'wirelessFailReason',width:100,align:'center',title:'无线原因分析',sortable:true,id:"wirelessFailReason_val"},
	            /*服务小区信息*/
	            {field:'saModel',width:100,align:'center',title:'制式',sortable:true},
	            ...
	            {field:'cellFriendlyName',width:100,align:'center',title:'小区友好名',sortable:true},
        ...
        function initTable(){
            $("#testLogInfoTable").datagrid({
                ...
                url:'${pageContext.request.contextPath}/saaccessexceptionview/doPageListJson.action?',
                title:'SA模式接入性异常事件分析',
                fitColumns:false,
                //填满区域
                fit:true,
        ...
        function getGpsPointData(recSeqNo,timeLong,typeName,lon,lat){
        	$.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/saaccessexceptionview/getGpsPointData.action",
                data:{
                	'recSeqNo':recSeqNo,
                	'timeLong':timeLong
					},
        ...
        var query = function(){
            ...
            $("#testLogInfoTable").datagrid({
                // 表头
                columns:testLogInfoColumns,
                url:'${pageContext.request.contextPath}/saaccessexceptionview/doPageListJson.action?nrFriendlyName='+roadName,
                title:'SA模式接入性异常事件分析',
                fitColumns:false,
                //填满区域
                fit:true,
