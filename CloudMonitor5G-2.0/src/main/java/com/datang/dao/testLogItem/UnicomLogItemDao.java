...
//		criteria.add(Restrictions.ne("startDateLong", new Long(0)));
	...
	public List<Map<String, Object>> dataOverviewSub(String idStr,boolean collect) {
		...
		String sqlTrue =
				"select \n" +
						"TASK_NAME,LOG_NAME,\n" +
						"ROUND(CASE WHEN KPI2097 = 0 then null else KPI2101/KPI2097*100 end ,2)as KK01,\n" +
						"ROUND(CASE WHEN KPI2015 = 0 then null else KPI3400/KPI2015*100 end ,2)as KK02,\n" +
						"ROUND(CASE WHEN KPI2015 = 0 then null else KPI5065/KPI2015*100 end ,2)as KK03,\n" +
						"ROUND(CASE WHEN KPI2015 = 0 then null else KPI2024/KPI2015*100 end ,2)as KK04,\n" +
						"ROUND(CASE WHEN (KPI2802*KPI5040) =0 OR (KPI2802*KPI5040) is null then null else (KPI2803/KPI2802)*(KPI5041/KPI5040)*100 end ,2)as KK05,\n" +
						"ROUND(CASE WHEN (KPI2151+KPI2154+KPI2621) =0 then null else (KPI2020/1000)/(KPI2151+KPI2154+KPI2621) end  ,2)as KK06,\n" +
						"ROUND(CASE WHEN (KPI2604+KPI2607+KPI2159+KPI2162+KPI2116) =0 then null else (KPI2610+KPI2613+KPI2165+KPI2168+KPI2119)/(KPI2604+KPI2607+KPI2159+KPI2162+KPI2116)*100 end  ,2)as KK07,\n" +
						"ROUND(CASE WHEN KPI2470 =0 then null else KPI2469/KPI2470*100 end  ,2)as KK08,\n" +
						"ROUND(CASE WHEN KPI2472 =0 then null else KPI2473/KPI2472*100 end  ,0)as KK09,\n" +
						"ROUND(KPI2560  ,2)as KK10,\n" +
						"ROUND(KPI2301\t ,2)as KK11,\n" +
						"ROUND(CASE WHEN KPI3697 =0 then null else KPI3694/KPI3697*100 end  ,2)as KK12,\n" +
						"ROUND(CASE WHEN KPI3697 =0 then null else KPI3696/KPI3697*100 end ,2)as KK13,\n" +
						"ROUND(KPI2300\t ,2)as KK14,\n" +
						"ROUND(CASE WHEN KPI3702 =0 then null else KPI3699/KPI3702*100 end  ,2)as KK15,\n" +
						"ROUND(CASE WHEN KPI3702 =0 then null else KPI3701/KPI3702*100 end  ,2)as KK16,\n" +
						"ROUND(CASE WHEN KPI5057 =0 then null else KPI5058/KPI5057*100 end ,2)as KK17,\n" +
						"ROUND(KPI5047\t ,2)as KK18,\n" +
						"ROUND(CASE WHEN KPI5049 =0 then null else KPI5050/KPI5049*100 end  ,2)as KK19,\n" +
						"ROUND(CASE WHEN KPI5049 =0 then null else KPI5051/KPI5049*100 end  ,2)as KK20,\n" +
						"ROUND(CASE WHEN KPI2761 =0 then null else KPI2762/KPI2761*100 end  ,2)as KK21,\n" +
						"ROUND(CASE WHEN (KPI2187+KPI2754) =0 then null else (KPI2204+KPI2755)/(KPI2187+KPI2754)*100 end  ,2)as KK22,\n" +
						"ROUND(CASE WHEN KPI2800 =0 then null else KPI2801/KPI2800*100 end  ,2)as KK23\n" +
						"from(\n" +
						"SELECT  "+ nickName + ",sum(KPI5065) AS KPI5065 ,sum(KPI2761) AS KPI2761 ,sum(KPI2762) AS KPI2762,sum(KPI2015) as KPI2015,sum(KPI2162) as KPI2162,sum(KPI2168) as KPI2168,sum(KPI2159) as KPI2159,sum(KPI2165) as KPI2165,sum(KPI2116) as KPI2116,sum(KPI2119) as KPI2119,sum(KPI2616) as KPI2616,sum(KPI2800) as KPI2800,sum(KPI2801) as KPI2801,sum(KPI2754) as KPI2754,sum(KPI2755) as KPI2755,sum(KPI2472) as KPI2472,sum(KPI2473) as KPI2473,sum(KPI2024) as KPI2024,sum(KPI2470) as KPI2470,sum(KPI2469) as KPI2469,sum(KPI2151) as KPI2151,sum(KPI2154) as KPI2154,sum(KPI2604) as KPI2604,sum(KPI2610) as KPI2610,sum(KPI2607) as KPI2607,sum(KPI2613) as KPI2613,sum(KPI2560) as KPI2560,sum(KPI2020) as KPI2020,sum(KPI2621) as KPI2621,sum(KPI2301) as KPI2301,sum(KPI2300) as KPI2300,sum(KPI2803) as KPI2803,sum(KPI2802) as KPI2802,sum(KPI2101) as KPI2101,sum(KPI2097) as KPI2097,sum(KPI2187) as KPI2187,sum(KPI2204) as KPI2204,sum(KPI3694) as KPI3694,sum(KPI3696) as KPI3696,sum(KPI3697) as KPI3697,sum(KPI3699) as KPI3699,sum(KPI3701) as KPI3701,sum(KPI3702) as KPI3702,sum(KPI3401) as KPI3401,sum(KPI3400) as KPI3400,sum(KPI4924) as KPI4924,sum(KPI5041) as KPI5041,sum(KPI5040) as KPI5040,sum(KPI5057) as KPI5057,sum(KPI5058) as KPI5058,sum(KPI5047) as KPI5047,sum(KPI5049) as KPI5049,sum(KPI5051) as KPI5051,sum(KPI5050) as KPI5050 from(\n" +
						...
						innerJoin +
						"UNION all\n" +
						"SELECT  ID,LOG.TASK_NAME,LOG_NAME,NULL AS KPI5065,NULL AS KPI2761,NULL AS KPI2762,null as KPI2015,null as KPI2162,null as KPI2168,null as KPI2159,null as KPI2165,null as KPI2116,null as KPI2119,null as KPI2616,null as KPI2800,null as KPI2801,null as KPI2754,null as KPI2755,null as KPI2472,null as KPI2473,null as KPI2024,null as KPI2470,null as KPI2469,null as KPI2151,null as KPI2154,null as KPI2604,null as KPI2610,null as KPI2607,null as KPI2613,null as KPI2560,null as KPI2020,null as KPI2621,null as KPI2301,null as KPI2300,null as KPI2803,null as KPI2802,null as KPI2101,null as KPI2097,null as KPI2187,null as KPI2204,null as KPI3694,null as KPI3696,null as KPI3697,null as KPI3699,null as KPI3701,null as KPI3702,null as KPI3401,null as KPI3400,KPI4924,null as KPI5041,null as KPI5040,null as KPI5057,null as KPI5058,null as KPI5047,null as KPI5049,null as KPI5051,null as KPI5050 FROM IADS_EXCEL_KPI_4 tt\n" +
						innerJoin +
						"UNION all\n" +
						"SELECT  ID,LOG.TASK_NAME,LOG_NAME,KPI5065,NULL AS KPI2761,NULL AS KPI2762,null as KPI2015,null as KPI2162,null as KPI2168,null as KPI2159,null as KPI2165,null as KPI2116,null as KPI2119,null as KPI2616,null as KPI2800,null as KPI2801,null as KPI2754,null as KPI2755,null as KPI2472,null as KPI2473,null as KPI2024,null as KPI2470,null as KPI2469,null as KPI2151,null as KPI2154,null as KPI2604,null as KPI2610,null as KPI2607,null as KPI2613,null as KPI2560,null as KPI2020,null as KPI2621,null as KPI2301,null as KPI2300,null as KPI2803,null as KPI2802,null as KPI2101,null as KPI2097,null as KPI2187,null as KPI2204,null as KPI3694,null as KPI3696,null as KPI3697,null as KPI3699,null as KPI3701,null as KPI3702,null as KPI3401,null as KPI3400,null as KPI4924,KPI5041,KPI5040,KPI5057,KPI5058,KPI5047,KPI5049,KPI5051,KPI5050 FROM IADS_EXCEL_KPI_5 tt\n" +
						innerJoin +
						")fff " + groupby +") tt\n"
				;
	...
	public List<Map<String, Object>> logCheckMd5(Date beginDate,Date endDate,List<String> idList){
		...
		String sql1= "\n" +
				...
				"\t\t\t\tcc.md51 MD51,\n" +
				"\t\t\t\tTO_CHAR(cc.START_TIME/(1*60*60*24) + TO_DATE('1970-01-01 08:00:00','YYYY-MM-DD HH:MI:SS'),'YYYY-MM-DD HH24:MI:SS') AS  START_TIME,\n" +
				"\t\t\t\tTO_CHAR(cc.END_TIME/(1*60*60*24) + TO_DATE('1970-01-01 08:00:00','YYYY-MM-DD HH:MI:SS'),'YYYY-MM-DD HH24:MI:SS') AS  END_TIME,\n" +
				"\t\t\t\tcc.min_lat MIN_LAT,\n" +
				"\t\t\t\tcc.max_lat MAX_LAT,\n" +
...
try{
	...
	String sql2 = "SELECT\n" +
			...
			"\tto_char(   CASE WHEN \"TIMESTAMP\" > 4102444800 OR \"TIMESTAMP\" < 0 THEN 0 ELSE \"TIMESTAMP\" END/(60*60*24) + TO_DATE('1970-01-01 08:00:00','YYYY-MM-DD HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS') AS TIMESTAMP1,\n" +
			"\tLONGITUDE AS LONGITUDE1,\n" +
			"\tLATITUDE AS LATITUDE1,\n" +
			"\tcc.FILE_NAME AS FILE_NAME2,\n" +
			"\tEVENTTYPE AS EVENTTYPE2,\n" +
			"\tto_char(   CASE WHEN \"TIMESTAMP\" > 4102444800 OR \"TIMESTAMP\" < 0 THEN 0 ELSE \"TIMESTAMP\" END/(60*60*24) + TO_DATE('1970-01-01 08:00:00','YYYY-MM-DD HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS') AS TIMESTAMP2,\n" +
			"\tLONGITUDE AS LONGITUDE2,\n" +
			"\tLATITUDE AS LATITUDE2,\n" +
			"\tcc.BOX_ID AS IMSI,\n" +
			"\tcc.FILE_NAME AS FILE_NAME3,\n" +
			"\tEVENTTYPE AS EVENTTYPE3,\n" +
			"\tto_char(   CASE WHEN \"TIMESTAMP\" > 4102444800 OR \"TIMESTAMP\" < 0 THEN 0 ELSE \"TIMESTAMP\" END/(60*60*24) + TO_DATE('1970-01-01 08:00:00','YYYY-MM-DD HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS') AS TIMESTAMP3,\n" +
	...
	private List<Map<String,Object>> bizCheckNew(String logFileWhere,String logTimeWhere){
		String sql2_cucc = "SELECT\n" +
				...
				"\tEVENTTYPE,\n" +
				"\tto_char(   CASE WHEN \"TIMESTAMP\" > 4102444800 OR \"TIMESTAMP\" < 0 THEN 0 ELSE \"TIMESTAMP\" END/(60*60*24) + TO_DATE('1970-01-01 08:00:00','YYYY-MM-DD HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS') AS TIMESTAMP,\n" +
				"\tLONGITUDE,\n" +
				"\tLATITUDE\n" +
				"FROM\n" +
				"\tIADS_CUCC_TRAFFICINFO CC\n" +
