  ...
  <head>
	...
	<script type="text/javascript">
		...
		var testLogInfoColumns=[[
			...
			{field:'cpu',width:45,align:'center',title:'CPU使用率(%)'},
			{field:'memory',width:60,align:'center',title:'内存使用率(%)'},
			{field:'spaceLeft',width:60,align:'center',title:'前端剩余磁盘空间（MB）'},
			{field:'imei',width:60,align:'center',title:'前端IMEI'},
			{field:'systemVersion',width:90,align:'center',title:'前端系统版本'},
			{field:'basebandVersion',width:90,align:'center',title:'前端基带版本'},
			{field:'deviceInfoTime',width:90,align:'center',title:'时间'}
		]];
		 $(function(){
		...
		function initTable(){
			$("#testLogInfoTable").datagrid({
				...
				url:'${pageContext.request.contextPath}/terminalInfo/doPageListJson.action',
				title:'终端信息监控列表',
				fitColumns:true,
				//填满区域
				fit:true,
