...
import com.datang.domain.gis.TestLogItemGrid100;
import com.datang.web.beans.VoLTEDissertation.compareAnalysis.TestLogItemGridBean;

/**
 * 测试日志全量指标栅格信息DAO(栅格大小100米)
 * 
 * @author yinzhipeng
 * @date:2016年6月30日 上午9:05:10
 * @version
 */
@Repository
@SuppressWarnings("all")
public class TestLogItemGrid100Dao extends
		GenericHibernateDao<TestLogItemGrid100, Long> {
	/**
	 ...
	 * @return
	 */
	public List<TestLogItemGridBean> getTestLogItemGrid100ByLogIdsAndIndexTypeGroupby(
