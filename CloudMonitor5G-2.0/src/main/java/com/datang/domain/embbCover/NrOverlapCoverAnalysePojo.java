 ...
 */
@Entity
@Table(name = "IADS_5G_EMBB_NR_OVERLAY")
public class NrOverlapCoverAnalysePojo  implements Serializable{
	...
	/**
	 * 重叠覆盖采样点最强beam RSRP均值（dBm）
	 */
	private String rsrp;
	
	/**
	 * 重叠覆盖采样点最强邻区RSRP均值（dBm）
	 */
