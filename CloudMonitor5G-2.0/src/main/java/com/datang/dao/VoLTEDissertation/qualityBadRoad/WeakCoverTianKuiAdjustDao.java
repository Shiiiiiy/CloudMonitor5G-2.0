...
import com.datang.domain.VoLTEDissertation.qualityBadRoad.weakCover.WeakCoverTianKuiAdjust;
...
public class WeakCoverTianKuiAdjustDao extends
		GenericHibernateDao<WeakCoverTianKuiAdjust, Long> {
	/**
	 * 根据根据弱覆盖路段获取弱覆盖质差路段中的天馈调整小区详情LIST
	 * 
	 * @param badRoadWeakCover
	 * @return
	 */
	public List<WeakCoverTianKuiAdjust> queryCellInfoByRoad(
