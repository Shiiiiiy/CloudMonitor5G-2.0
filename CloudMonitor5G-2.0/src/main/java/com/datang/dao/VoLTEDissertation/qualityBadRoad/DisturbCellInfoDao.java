...
import com.datang.domain.VoLTEDissertation.qualityBadRoad.disturbProblem.DisturbProblemRoadCellInfo;
import com.datang.domain.VoLTEDissertation.qualityBadRoad.disturbProblem.VolteQualityBadRoadDisturbProblem;

/**
 * volte质量专题---volte语音质差---干扰小区详情Dao
 * 
 * @author yinzhipeng
...
public class DisturbCellInfoDao extends
		GenericHibernateDao<DisturbProblemRoadCellInfo, Long> {
	/**
	 ...
	 * @return
	 */
	public List<DisturbProblemRoadCellInfo> queryCellInfoByRoad(
		...
		Criteria createCriteria = this.getHibernateSession().createCriteria(
				DisturbProblemRoadCellInfo.class);
