...
<head>
    ...
    <script type="text/javascript">
        ...
        var testLogInfoColumns=[[
	    		{field:'itemid',align:'center',colspan:5,title:'异常事件基础信息'},
	            ...
	            {field:'scellChangeFailTime',width:100,align:'center',title:'业务类失败发生时间',sortable:true},
	            ...
	            {field:'fileName',width:100,align:'center',title:'文件名称',sortable:true,
	                formatter:function(value,row,index){
	                    if(row.fileName){
	                        ...
	                        return '<a title="" href="${pageContext.request.contextPath}/bussinessexceptionview/downloadFile.action?fileId='+row.id+'&reqSeqNo='+row.testLogItem.recSeqNo+'" >'+filename+'</a>';
	                    }
	                    return value;
	                }
	            },
	            ...
	            /*原因分析*/
	            /*todo*/
	            {field:'scellChangeFailType',width:100,align:'center',title:'业务类失败类型',sortable:true},
        ...
        function initTable(){
            $("#testLogInfoTable").datagrid({
                ...
                url:'${pageContext.request.contextPath}/bussinessexceptionview/doPageListJson.action?',
                title:'业务类异常事件分析',
                fitColumns:false,
                //填满区域
                fit:true,
        ...
        function getGpsPointData(recSeqNo,timeLong,typeName,lon,lat){
        	$.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/bussinessexceptionview/getGpsPointData.action",
                data:{
                	'recSeqNo':recSeqNo,
                	'timeLong':timeLong
					},
        ...
        var query = function(){
            ...
            $("#testLogInfoTable").datagrid({
                // 表头
                columns:testLogInfoColumns,
                url:'${pageContext.request.contextPath}/bussinessexceptionview/doPageListJson.action?nrFriendlyName='+roadName,
                title:'业务类异常事件分析',
                fitColumns:false,
                //填满区域
                fit:true,
