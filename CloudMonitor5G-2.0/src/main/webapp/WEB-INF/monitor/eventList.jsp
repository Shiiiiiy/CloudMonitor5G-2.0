  ...
  <head>
	...
	<script type="text/javascript">
		...
		var testLogInfoColumns=[[
			...
			{field:'channelType',width:90,align:'center',title:'通道类型'},
			{field:'eventType',width:75,align:'center',title:'事件类型'},
			{field:'eventCode',width:60,align:'center',title:'事件代码'},
			{field:'eventName',width:90,align:'center',title:'事件名称'},
			{field:'eventTime',width:75,align:'center',title:'事件时间'}
		]];
		$(function(){
		...
		function initTable(){
			$("#testLogInfoTable").datagrid({
				...
				url:'${pageContext.request.contextPath}/event/doPageListJson.action',
				title:'事件监控列表',
				fitColumns:true,
				//填满区域
				fit:true,
    	...
    	<div id="ly" class="easyui-layout"  style="width:100%;height: 100%;padding:4px;top:4px;left:4px;position: absolute;">
	    	...
	    	<div data-options="region:'north',title:'筛选条件设置',onCollapse:function(){
    			...
    			<form id="queryForm" class="esyui-form" method="post" style="width:100%;height: 100%;margin:0;" >
			    	...
			    	<div class="inputDivShow">事件代码
			    		<input id="eventCode" name="eventCode"  class="easyui-numberbox" data-options="validType:'length[1,30]'"/>
			    	</div>
