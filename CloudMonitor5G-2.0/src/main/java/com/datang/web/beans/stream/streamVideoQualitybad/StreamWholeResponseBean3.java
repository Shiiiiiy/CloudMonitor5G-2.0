...
/**
 * 流媒体视频质差整体分析视频质差关键参数响应bean
 * 
 * @explain
 * @name StreamWholeResponseBean3
 * @author shenyanwei
 * @date 2017年10月23日下午1:43:24
 */
public class StreamWholeResponseBean3 implements Serializable {
	...
	public String toString() {
		return "VideoWholeResponseBean3 [cause=" + cause + ", pingPongNum="
				...
				+ overCoverRatio + ", downDispatchSmallNum="
				+ downDispatchSmallNum + ", downDispatchSmallRatio="
				+ downDispatchSmallRatio + ", otherNum=" + otherNum
				+ ", otherRatio=" + otherRatio + ", collectNum=" + collectNum
