function initGoogle()
{
    ...
    //影像
    dojo.declare("GoogleMapImgLayer", esri.layers.TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer
        constructor: function(){
            this.spatialReference = new esri.SpatialReference({wkid: 102113});
            this.initialExtent = (this.fullExtent
                = new esri.geometry.Extent(-20037508.342787, -20037508.342787, 20037508.342787, 20037508.342787, this.spatialReference));
        ...
        getTileUrl: function(level, row, col){
            //return "http://mt"+(col % 4)+".google.cn/vt/lyrs=s@110&hl=zh-CN&gl=cn&src=app&x="+col+"&y="+row+"&z="+level+"&s=Gali";
            return  " http://www.google.cn/maps/vt?lyrs=s@183&gl=cn&x="+col+"&y="+row+"&z="+level+"&s=";
        }
    });
    //标记
