...
<html>
	<head>
	    <title>VoLTE质量专题----VoLTE切换失败----SRVCC失败</title>
		...
		<script type="text/javascript">
			...
			function reloadThisPageTab(title,index){
				...
				var url;
				if('整体'==title){
					url = '${pageContext.request.contextPath}/droppingSRVCC/goToWhole.action';
					if(0==wholeClickNum){
						$(target).tabs('update', {
							tab : currTab,
							options : {
					...
					url = '${pageContext.request.contextPath}/droppingSRVCC/goToProblem.action';
