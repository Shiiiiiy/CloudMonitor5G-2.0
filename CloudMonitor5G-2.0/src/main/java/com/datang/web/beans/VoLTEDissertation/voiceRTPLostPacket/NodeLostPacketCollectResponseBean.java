...
/**
 * 语音RTP连续丢包--节点丢包情况--响应bean
 * 
 * @explain
 * @name NodeLostPacketCollectResponseBean
 * @author shenyanwei
 * @date 2017年2月17日上午11:22:08
 */
public class NodeLostPacketCollectResponseBean implements Serializable {
