...
<html>
  <head>
	...
	$(function(){
		...
		$('#tt').tabs({
			tools:[{
				...
				iconCls:'icon-excel',
				handler:function(){
					goToPage("${pageContext.request.contextPath}/cqtReport/downloadOneSheetVolteVoiceTotalExcel.action?sheetName="+sheetName+"");
				}
			},{
				iconCls:'icon-batchexcel',
				text:'批量导出',
				handler:function(){
					goToPage('${pageContext.request.contextPath}/cqtReport/downloadVolteVoiceTotalExcel.action');
				}
			}]
		});
	});
	...
	//加载数据
	function initTable(){
		$.post("${pageContext.request.contextPath}/cqtReport/quaryVoiceKpi.action",{},
			function(result){
				if (result.errorMsg) {
					...
					if(collectTypes){
						for(var i=1;i<10;i++){
							...
							if(s==-1){
								...
								$('#Table4').datagrid('hideColumn',valu);
								$('#Table5').datagrid('hideColumn',valu);
								$('#Table6').datagrid('hideColumn',valu);
								$('#Table7').datagrid('hideColumn',valu);
							}
						}
				} 
					$("#Table1").datagrid('loadData',result.info.totalKpi);
					$("#Table2").datagrid('loadData',result.info.volteKpi);
					$("#Table3").datagrid('loadData',result.info.csKpi);
					$("#Table4").datagrid('loadData',result.info.coverKpi);
					$("#Table5").datagrid('loadData',result.info.disturbKpi);
					$("#Table6").datagrid('loadData',result.info.dispatcherKpi);
					$("#Table7").datagrid('loadData',result.info.mosKpi);
				...
				<a>开始时间：<input id="beg1"type="text" class="easyui-textbox" style="width:35%;height:100%">  结束时间：<input id="end1" type="text" class="easyui-textbox"  style="width:35%;height:100%"></a>
  					<table id="Table1" class="easyui-datagrid" data-options="striped:true,fitColumns:false,singleSelect:true"   >
	    				<thead>
	    					...
	    					<tr>
	    						<th data-options="field:'callcompleterate',width:80,align:'center'">全程呼叫成功率</th>
	    						<th data-options="field:'callconnectrate',width:80,align:'center'">接通率</th>
	    						<th data-options="field:'calldroprate',width:80,align:'center'">掉话率</th>
				...
				<a>开始时间：<input id="beg6"type="text" class="easyui-textbox" style="width:35%;height:100%">  结束时间：<input id="end6" type="text" class="easyui-textbox"  style="width:35%;height:100%"></a>
  					<table id="Table6"  class="easyui-datagrid" data-options="scrollbarSize:0,striped:true,fitColumns:false,singleSelect:true"  >
	    				<thead>
	    					...
	    					<tr>
	    						<th rowspan="2"data-options="field:'ulrbscheduleaverage',width:80,align:'center'">上行平均RB</th>
	    						<th rowspan="2" data-options="field:'dlrbscheduleaverage',width:80,align:'center'">下行平均RB</th>
	    					...
	    					<tr>
	    						<th data-options="field:'codeword0',width:80,align:'center'">码字0</th>
	    						<th data-options="field:'codeword1',width:80,align:'center'">码字1</th>
	    						<th data-options="field:'codeword0',width:70,align:'center'">码字0</th>
	    						<th data-options="field:'codeword1',width:100,align:'center'">码字1</th>
  					...
  					<table id="Table7" class="easyui-datagrid" data-options="scrollbarSize:0,striped:true,fitColumns:false,singleSelect:true"  >
	    				<thead>
	    					...
	    					<tr>
	    						...
	    						<th data-options="field:'psmos0t22',width:120,align:'center'">[2.1,2.2)</th>
	    						<th data-options="field:'psmos0t23',width:120,align:'center'">[2.2,2.3)</th>
	    						<th data-options="field:'psmos0t24',width:120,align:'center'">[2.3,2.4)</th>
	    						<th data-options="field:'psmos0t25',width:120,align:'center'">[2.4,2.5)</th>
	    						<th data-options="field:'psmos0t26',width:120,align:'center'">[2.5,2.6)</th>
	    						<th data-options="field:'psmos0t27',width:120,align:'center'">[2.6,2.7)</th>
	    						<th data-options="field:'psmos0t28',width:120,align:'center'">[2.7,2.8)</th>
	    						<th data-options="field:'psmos0t29',width:120,align:'center'">[2.8,2.9)</th>
	    						<th data-options="field:'psmos0t30',width:120,align:'center'">[2.9,3)</th>
	    						<th data-options="field:'psmos0t31',width:120,align:'center'">[3,3.1)</th>
	    						<th data-options="field:'psmos0t32',width:120,align:'center'">[3.1,3.2)</th>
	    						<th data-options="field:'psmos0t33',width:120,align:'center'">[3.2,3.3)</th>
	    						<th data-options="field:'psmos0t34',width:120,align:'center'">[3.3,3.4)</th>
	    						<th data-options="field:'psmos0t35',width:120,align:'center'">[3.4,3.5)</th>
	    						<th data-options="field:'psmos0t36',width:120,align:'center'">[3.5,3.6)</th>
	    						<th data-options="field:'psmos0t37',width:120,align:'center'">[3.6,3.7)</th>
	    						<th data-options="field:'psmos0t38',width:120,align:'center'">[3.7,3.8)</th>
	    						<th data-options="field:'psmos0t39',width:120,align:'center'">[3.8,3.9)</th>
	    						<th data-options="field:'psmos0t40',width:120,align:'center'">[3.9,4)</th>
	    						<th data-options="field:'psmos0t41',width:120,align:'center'">[4,4.1)</th>
	    						<th data-options="field:'psmos0t42',width:120,align:'center'">[4.1,4.2)</th>
	    						<th data-options="field:'psmos0t43',width:120,align:'center'">[4.2,4.3)</th>
	    						<th data-options="field:'psmos0t44',width:120,align:'center'">[4.3,4.4)</th>
	    						<th data-options="field:'psmos0t45',width:120,align:'center'">[4.4,4.5)</th>
	    						<th data-options="field:'psmos0t50',width:120,align:'center'">[4.5,5)</th>
	    						<th data-options="field:'csmos0t21',width:100,align:'center'">[0,2.1)</th>
	    						<th data-options="field:'csmos0t22',width:120,align:'center'">[2.1,2.2)</th>
	    						<th data-options="field:'csmos0t23',width:120,align:'center'">[2.2,2.3)</th>
	    						<th data-options="field:'csmos0t24',width:120,align:'center'">[2.3,2.4)</th>
	    						<th data-options="field:'csmos0t25',width:120,align:'center'">[2.4,2.5)</th>
	    						<th data-options="field:'csmos0t26',width:120,align:'center'">[2.5,2.6)</th>
	    						<th data-options="field:'csmos0t27',width:120,align:'center'">[2.6,2.7)</th>
	    						<th data-options="field:'csmos0t28',width:120,align:'center'">[2.7,2.8)</th>
	    						<th data-options="field:'csmos0t29',width:120,align:'center'">[2.8,2.9)</th>
	    						<th data-options="field:'csmos0t30',width:120,align:'center'">[2.9,3)</th>
	    						<th data-options="field:'csmos0t31',width:120,align:'center'">[3,3.1)</th>
	    						<th data-options="field:'csmos0t32',width:120,align:'center'">[3.1,3.2)</th>
	    						<th data-options="field:'csmos0t33',width:120,align:'center'">[3.2,3.3)</th>
	    						<th data-options="field:'csmos0t34',width:120,align:'center'">[3.3,3.4)</th>
	    						<th data-options="field:'csmos0t35',width:120,align:'center'">[3.4,3.5)</th>
	    						<th data-options="field:'csmos0t36',width:120,align:'center'">[3.5,3.6)</th>
	    						<th data-options="field:'csmos0t37',width:120,align:'center'">[3.6,3.7)</th>
	    						<th data-options="field:'csmos0t38',width:120,align:'center'">[3.7,3.8)</th>
	    						<th data-options="field:'csmos0t39',width:120,align:'center'">[3.8,3.9)</th>
	    						<th data-options="field:'csmos0t40',width:120,align:'center'">[3.9,4)</th>
	    						<th data-options="field:'csmos0t41',width:120,align:'center'">[4,4.1)</th>
	    						<th data-options="field:'csmos0t42',width:120,align:'center'">[4.1,4.2)</th>
	    						<th data-options="field:'csmos0t43',width:120,align:'center'">[4.2,4.3)</th>
	    						<th data-options="field:'csmos0t44',width:120,align:'center'">[4.3,4.4)</th>
	    						<th data-options="field:'csmos0t45',width:120,align:'center'">[4.4,4.5)</th>
	    						<th data-options="field:'csmos0t50',width:120,align:'center'">[4.5,5)</th>
	    					</tr>
	    				</thead>
	    				<tbody>
	    				<tr></tr>
