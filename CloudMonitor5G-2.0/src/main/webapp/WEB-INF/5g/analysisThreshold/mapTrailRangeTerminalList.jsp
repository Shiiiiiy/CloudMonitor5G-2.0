...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function clickTreeNode(node){
			...
			centerLayoutGoToPage('【'+node.text+'】轨迹图参数阈值设置','${pageContext.request.contextPath}/mapTrailLegendParam/displayMapRangeParamListUI.action?cityId='+node.attributes.refId+'&colorMapType=mapNrPlanColor');
		}
	</script>
  </head>
  ...
  <body id="cc" class="easyui-layout" style="width:100%;height: 100%;margin: 0 auto;list-style:none;overflow:hidden;">
    	...
    	<!-- 中,终端列表 -->
    	<div  data-options="region:'center',title:'轨迹图参数阈值设置'" >
    	</div>
