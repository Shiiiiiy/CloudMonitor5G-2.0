...
<div id="layerManagerWin" class="easyui-window" title="图层管理" style="width:600px;height:400px;"
    ...
    <div style="width:99%;height: 80%;">
    	<div class="easyui-tabs" id="layerManagerTab" data-options="fit:true,plain:true,border:false" style="padding:4px;">
			<div data-options="closeable:'false',title:'图例',cache:false,selected:true" style="padding:4px;">
				<div style="width:100%;height: 100%;">
					...
					<div style="width:50%;height: 100%;float:left;">
						...
						<div style="width:100%;height: 20%;">
							<div style="text-align:center">
							   	<a id="btn" class="easyui-linkbutton" onclick="targetFoatFunc()">标签字体</a>
							   	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div data-options="closeable:'false',title:'连线',cache:false" style="padding:4px;">
				<div style="heigth: 45%;">
					<div style="height: 5%;"><h4 style="color: #0F2B5F;">小区连线样式</h4></div>
					<div style="heigth: 40%;margin-top: 10px;">
						<input style="display:none;" type="checkbox" id="cellCoverThreshold" name="cellCoverThreshold" value="1" 
						checked="checked" onclick="cellCoverThresholdFunc()">
						<!-- 小区覆盖有效性门限  RSRP>=<input id="cellCoverThresholdVal" style="width: 40px;" type="text"> -->
					</div>
					<div style="heigth: 50%;margin-top: 10px;">
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="cellLinkColor" onclick="showImgCheckedFunc('cellCoverThreshold')" value="1">相同颜色
							&nbsp;&nbsp;<input id="cellLinkColorInput" style="width: 40px;" type="color">
							&nbsp;&nbsp;
							<input type="radio" name="cellLinkColor" onclick="showImgCheckedFunc('cellCoverThreshold')" value="2">和采样点颜色一样
					</div>
				</div>
				<div style="heigth: 55%;margin-top: 10px;display:none;">
					<div style="height: 5%;"><h4 style="color: #0F2B5F;">邻小区连线样式</h4></div>
					<div style="heigth: 30%;margin-top: 10px;">
						<input type="checkbox" name="showNumber" id="showNumber" value="1" checked="checked" onclick="showNumberFunc()">显示数量&nbsp;&nbsp;
							<select id='showNumberSelect' style="width: 60px;">
					...
					<div style="heigth: 70%;margin-top: 10px;">
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="ncellLinkColor" onclick="showImgCheckedFunc('showNumber')" value="1">相同颜色
							&nbsp;&nbsp;<input id='ncellLinkColorInput' style="width: 40px;" type="color" value='#0AAB5B'>
							<div style="margin-top: 10px;"></div>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="ncellLinkColor" onclick="showImgCheckedFunc('showNumber')" value="2">根据强度显示不同颜色
							<div style="margin-top: 10px;"></div>
							&nbsp;&nbsp;&nbsp;&nbsp;
							TOP1<input name='topColor' type="color"  style="width: 40px;">&nbsp;&nbsp;
							TOP2<input name='topColor' type="color"  style="width: 40px;">&nbsp;&nbsp;
							TOP3<input name='topColor' type="color"  style="width: 40px;">&nbsp;&nbsp;
							TOP4<input name='topColor' type="color"  style="width: 40px;">&nbsp;&nbsp;
							TOP5<input name='topColor' type="color"  style="width: 40px;">&nbsp;&nbsp;
							TOP6<input name='topColor' type="color"  style="width: 40px;">&nbsp;&nbsp;
					</div>
				</div>
			</div>
			<div data-options="closeable:'false',title:'事件',cache:false" style="padding:4px;">
				<div style="width:45%;height: 100%;float:left;">
					<div style="height: 10%;"><h4 style="color: #0F2B5F;">事件库</h4></div>
					<div style="height: 90%;width: 100%;overflow:auto;">
						<ul id="eventTree" class="easyui-tree"></ul>
					</div>
				</div>
				<div style="width:10%;height: 100%;float:left;">
					<div style="height: 30%;"></div>
					<div style="height: 10%;"><input type="button" style="width: 80%;margin-left: 5%;" value=">" onclick="addOneEventFunc()" /></div>
					<div style="height: 10%;"><input type="button" style="width: 80%;margin-left: 5%;" value="&lt;" onclick="removeOneEventFunc()" /></div>
					<div style="height: 10%;"><input type="button" style="width: 80%;margin-left: 5%;" value=">>" onclick="addAllEventFunc()" /></div>
					<div style="height: 10%;"><input type="button" style="width: 80%;margin-left: 5%;" value="&lt;&lt;" onclick="removeAllEventFunc()" /> </div>
					<div style="height: 30%;"></div>
				</div>
				<div style="width:45%;height: 100%;float:left;">
					<div style="height: 10%;"><h4 style="color: #0F2B5F;">事件列表</h4></div>
					<div style="height: 90%;width: 100%;overflow:auto;">
						<div style="width: 100%;height: 90%">
...
<script type="text/javascript">
    ...
    function analyseMap(boshuData){
		...
		if(beamId && boshuLimits){
			for(var i = 0;i < boshuData.length; i++){
				...
				data.push([boshuData[i].value, boshuData[i].angle]);
			}
		}else if(beamId){
			for(var i = 0;i < boshuData.length; i++){
				if(boshuData[i].beamId != beamId){
	...
	function showImgFunc(){
		if($('input[name="showImg"]:checked').length == 0){
			$("input[name=showImgColor]").attr("checked",false);
		}else{
			$("input[name=showImgColor]")[0].checked = true;
		}
	}
	...
	function saveLayerManage(){
		...
		var LayerManageShowEventData = [
			[
				{iconType:'5G切换尝试',longitude:108.351627,latitude:31.166698},
				{iconType:'5G切换成功',longitude:108.35365,latitude:31.167777},
				{iconType:'5G切换失败',longitude:108.356378,latitude:31.16726},
				{iconType:'5G同频切换尝试',longitude:108.350368,latitude:31.16724},
				{iconType:'5G同频切换成功',longitude:108.354113,latitude:31.167745},
				{iconType:'5G异频切换尝试',longitude:108.351937,latitude:31.166807},
				{iconType:'5G异频切换成功',longitude:108.356483,latitude:31.167373},
				{iconType:'位置更新尝试',longitude:108.35321,latitude:31.165813},
				{iconType:'位置更新成功',longitude:108.35393,latitude:31.167713},
				{iconType:'位置更新失败',longitude:108.35383,latitude:31.167843},
				{iconType:'5G到LTE互操作尝试',longitude:108.35343,latitude:31.167823},
				{iconType:'5G到LTE互操作成功',longitude:108.35433,latitude:31.167853},
				{iconType:'Same_LTE_Diff_NR成功',longitude:108.35336,latitude:31.167873},
				{iconType:'Same_LTE_Diff_NR尝试',longitude:108.35233,latitude:31.167843}
			]
		]
	...
	function showCellLayer(){
		var cellShowFlag = false;
		var showTargetFlag = false;
		/* for(var i = 0;i < layerManageData.layerChooseData.length;i++){
		...
		mapIframe.window.LayerManageAddCellbyArray2(cellShowFlag,colors,cellRange,layerManageData.cellData.showTarget.showTargetOption,showTargetFlag);
	}
	...
	function ShowCellToCell(){
		if($('#showNumber')[0].checked){
			...
			*/
			...
			var netType = [
				{cellId:'109445549',nbCellId:'55969065',top:1},
				{cellId:'55997226',nbCellId:'109445547',top:2}
				];
	...
	function showRoadPointsDataFunc(){
    	...
    	var boshuScope = $("#boshuScope").val();
    	var boshuChoose = $('input[name=boshuChoose]:checked').val();
    	console.log(boshuChoose);
    	console.log(showRoadPointsData);
    	if(boshuScope!=null){
    		if(showRoadPointsData){
    	    	var data = JSON.parse(JSON.stringify(showRoadPointsData));
    	    	for(var i = 0; i < showRoadPointsData[0].length;i++){
